...
🔭 Atualmente trabalho como **Motorista de Aplicativo**, mas estou em transição para a área de **Tecnologia**.  

🌱 Estudo **Java**, **Python** e **PostgreSQL** para me tornar **Desenvolvedor Back-end**.  

👯 Procuro colaborar em projetos de **back-end, APIs e bancos de dados**.  

🤔 Busco aprender mais sobre **boas práticas, POO e frameworks (Spring Boot)**.  
